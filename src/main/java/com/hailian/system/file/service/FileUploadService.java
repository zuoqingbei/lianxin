package com.hailian.system.file.service;
...
import com.hailian.system.file.service.impl.AliOssBackup;
import com.hailian.system.file.service.impl.EmptyBackUp;
import com.hailian.system.file.service.impl.FileManangerBackup;
import com.hailian.system.file.util.FileUploadConstants;
...
public class FileUploadService extends BaseService {
	...
	* @TODO
	...
	public boolean saveCreditFile(FileUploadBean bean, int businessType, int userid) {
		...
		model2.set("originalname", bean.getOriginalName());
		model2.set("type", bean.getType());
		model2.set("size", bean.getSize());
		model2.set("size", bean.getSize());
		model2.set("update_date", now);
		model2.set("update_by", userid);
		model2.set("create_date", now);
