...
public class UploadFileService {
	...
	* @TODO
	...
	public boolean save(Integer pid,UploadFile uploadBean,String factpath,String url,String pdfFactpath,String pdfUrl, CreditUploadFileModel model, String fileName, Integer userid) {
        long size = uploadBean.getFile().length();
        String originalName = uploadBean.getOriginalFileName();
        return save(pid, originalName, size, factpath, url, pdfFactpath, pdfUrl, model, fileName, userid);
    }
     ...
     * @TODO
     */
    public boolean save(Integer pid, String originalName,long size,String factpath,String url,String pdfFactpath,String pdfUrl, CreditUploadFileModel model, String fileName, Integer userid){
        boolean flag=false;
