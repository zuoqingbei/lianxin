        ...
        try {
           ...
           /* if("credit_company_shareholder".equals(tableName)){
            ...
            if(StringUtils.isNotBlank(companyId)&&"credit_company_info".equals(tableName)&&"CreditCompanyInfo".equals(className)){
            	...
            	targetStr+=" LEFT JOIN sys_dict_detail a1 on c.businessincome_type=a1.detail_id LEFT JOIN sys_dict_detail a2 on c.totalassets_type=a2.detail_id LEFT JOIN sys_dict_detail a3 on c.periodofstockholder_type=a3.detail_id ";
