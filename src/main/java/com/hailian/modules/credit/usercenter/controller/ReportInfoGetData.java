...
public abstract class ReportInfoGetData extends BaseProjectController {
  ...
  static {
        ...
        for(int i=0;i<jsonArray.size();i++){
            ...
            for (String key : map.keySet()) {
                mapParse.put(key.replace("锟斤拷锟斤拷之锟斤拷锟窖э拷锟", ":").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷", ",").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷1", "}").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷2", "{").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷3", "]")
                        , map.get(key).toString().replaceAll("●&nbsp;", "●").replaceAll(".rn", ".").replace("锟斤拷锟斤拷之锟斤拷锟窖э拷锟", ":").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷", ",").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷1", "}").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷2", "{").replace("锟э窖拷锟锟斤拷锟斤拷*锟斤拷3", "]"));
            }
            list.add(mapParse);
        }
        return list;
	}
	public static  List<Map<Object,Object>> parseJsonArray2(String jsonStr){
        List<Map<Object,Object>> list = new ArrayList<>();
        System.out.println(jsonStr);
        JSONArray jsonArray = JSONArray.fromObject(jsonStr);
        for(int i=0;i<jsonArray.size();i++){
	...
	public static void main(String[] args) {
		//String jsonStr="[{\"company_id\":7781493,\"id\":\"749\",\"industry_code\":\"9876545678\",\"industry_name\":\"Textile industry\",\"industry_analy\":\" In recent years, China's textile fiber processing volume has maintained steady growth.  According to the statistics of the Ministry of Industry and Information Technology, in 2016, the national textile fiber processing volume reached 54.2 million tons, a year-on-year increase of 2.3%, accounting for more than 50% of the total global fiber processing.  The “13th Five-Year” development plan predicts that in the next four years, China's fiber processing capacity will continue to grow at a rate of 1 million to 2 million tons per year, and will reach 60 million tons in 2020, an increase of 3.5%.  China is already the world's largest textile processing country and the world's largest textile exporter.  According to the statistics of China Textile Industry Association, since 2010, China's textile and garment exports accounted for a steady increase in the proportion of global textile and apparel exports, but the growth rate has gradually slowed down.  In 2016, global textile and apparel exports accounted for 38%.  However, customs data shows that in the whole year of 2015, China's textile and apparel exports reached 291.1 billion US dollars, down 4.8% year-on-year.  Among them, China's textile exports were 115.26 billion US dollars, down 2.3% year-on-year; clothing exports were 175.89 billion US dollars, down 6.4% year-on-year.  This is also the first year of negative growth in China's textile and apparel exports since the financial crisis.  In 2016, the export situation did not improve.  The same is true for customs data.  The cumulative trade volume of China's textiles and apparel in 2016 was US$290.6 billion, down 6.1% year-on-year.  Among them, exports were 267.25 billion US dollars, down 5.9% year-on-year.  This is the first time that China’s textile exports have declined in the past 20 years, and the decline has increased year by year.  In terms of retail sales, the retail sales of clothing, footwear and knitwear above designated size increased steadily.  In 2016, the retail sales amounted to 144.3 billion yuan, accounting for 9.95% of the retail sales of consumer goods above designated size.\",\"chart_title\":\"The growth trend of China's textile industry in the past five years\",\"chart_remark\":\"The X axis represents time; the Y1 axis represents the export volume; Y2 represents the growth rate\"}]";
		String jsonStr="[{\"company_id\":7781493,\"id\":\"749\",\"industry_code\":\"9876545678\",\"industry_name\":\"Textile industry\",\"industry_analy\":\" In recent years, China's textile fiber processing volume has maintained steady growth. According to the statistics of the Ministry of Industry and Information Technology, in 2016, the national textile fiber processing volume reached 54.2 million tons, a year-on-year increase of 2.3%, accounting for more than 50% of the total global fiber processing. The “13th Five-Year” development plan predicts that in the next four years, China's fiber processing capacity will continue to grow at a rate of 1 million to 2 million tons per year, and will reach 60 million tons in 2020, an increase of 3.5%. China is already the world's largest textile processing country and the world's largest textile exporter. According to the statistics of China Textile Industry Association, since 2010, China's textile and garment exports accounted for a steady increase in the proportion of global textile and apparel exports, but the growth rate has gradually slowed down. In 2016, global textile and apparel exports accounted for 38%. However, customs data shows that in the whole year of 2015, China's textile and apparel exports reached 291.1 billion US dollars, down 4.8% year-on-year. Among them, China's textile exports were 115.26 billion US dollars, down 2.3% year-on-year; clothing exports were 175.89 billion US dollars, down 6.4% year-on-year. This is also the first year of negative growth in China's textile and apparel exports since the financial crisis. In 2016, the export situation did not improve. The same is true for customs data. The cumulative trade volume of China's textiles and apparel in 2016 was US$290.6 billion, down 6.1% year-on-year. Among them, exports were 267.25 billion US dollars, down 5.9% year-on-year. This is the first time that China’s textile exports have declined in the past 20 years, and the decline has increased year by year. In terms of retail sales, the retail sales of clothing, footwear and knitwear above designated size increased steadily. In 2016, the retail sales amounted to 144.3 billion yuan, accounting for 9.95% of the retail sales of consumer goods above designated size.\",\"chart_title\":\"The growth trend of China's textile industry in the past five years\",\"chart_remark\":\"The X axis represents time; the Y1 axis represents the export volume; Y2 represents the growth rate\"}]";
		System.out.println(parseJsonArray(jsonStr));;
	}
