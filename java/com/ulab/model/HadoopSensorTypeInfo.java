...
public class HadoopSensorTypeInfo {
	...
	public List<Record> findSensorTypeInfoByLabCode(BaseController c,String configName,String labCode){
		...
		String sql="select labcode,sensortypeid,sensortypename,highvalue,lowvalue,unit from "+tableName+" where labcode='"+labCode+"' "+DbConfigModel.dao.getPartitionSql(c, configName, labCode)+" order by sensortypeid ";
