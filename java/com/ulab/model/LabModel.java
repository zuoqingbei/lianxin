...
public class LabModel extends Model<LabModel> {
	...
	public Record labLink() {
		...
		sb.append("  left join (select count(*) as link_num from t_b_lab_info lab where lab.del_flag="+Constants.DEL_FALG+" and lab.link_status="+Constants.DEL_FALG+" )b on 1=1  ");
